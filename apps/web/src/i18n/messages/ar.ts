...
export const webMessagesAr: WebMessages = {
  ...
  loans: {
    title: "القروض والادخار",
    description:
      "واجهة توفر صادقة لمنتجات رأس المال داخل بوابة العميل المُدارة.",
    alertTitle: "الإقراض الذاتي للعميل غير مفعّل",
    alertDescription:
      "واجهة برمجة تطبيقات العميل الحالية تعرض الأرصدة ودورة حياة الحساب وربط المحفظة وسجل الدفتر. لكنها لا تعرض إنشاء القروض أو جداول السداد أو منتجات الادخار أو نسب العائد أو مسارات طلبات العملاء، لذلك تمت إزالة النماذج الوهمية القديمة."
  },
  profile: {
